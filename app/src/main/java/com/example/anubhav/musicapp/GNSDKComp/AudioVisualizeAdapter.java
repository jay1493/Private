...
public class AudioVisualizeAdapter implements IGnAudioSource {
    ...
    public AudioVisualizeAdapter( IGnAudioSource audioSource,AudioVisualDisplay display ){
        this.audioSource = audioSource;
        this.audioVisualDisplay = display;
    }
    ...
    public long getData(ByteBuffer buffer, long bufferSize) {
        ...
        if ( numBytes != 0 ) {
            ...
            audioVisualDisplay.setAmplitudePercent(rmsPercentOfMax(buffer,bufferSize,numBitsPerSample,numChannels), true);
        }
